...
if len(sys.argv) == 9:
    ...
    training_sets = int(sys.argv[5])
    dict_component = int(sys.argv[6])
    sample_len = int(sys.argv[7])
    ...
    print "Please give arguments with the form of:  [MP_to_use] [y_file w/ .h5 subfix] [output file] [#mp_sparsity]  [#training_sets] [#measurements in dictionary] [#features(y_sample length)] [#samples per set]"
    sys.exit(0)
