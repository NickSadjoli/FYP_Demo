...
if len(sys.argv) == 7:
	...
	print "Invalid, please try again! \n(Args expected: [Folder of choice] [start index for checking] [Phi's file (\w .h5 subfix)] [y's file(\w .h5 subfix)] [# sparsity used by the MP algo] [# repeats/testing to be done])"
	sys.exit(0)
