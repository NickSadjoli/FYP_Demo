...
SPS_CODE_FOLDER = "sparse_code_demo"
DCT_FOLDER = "dct_demo"
DWT_FOLDER = "dwt_demo"
...
spscode_runtime, _, _, _ = take_data(SPS_CODE_FOLDER + "/sps_code_runtime.h5")
dct_runtime, _, _, _ = take_data(DCT_FOLDER + "/dct_runtime.h5")
dwt_runtime, _, _, _ = take_data(DWT_FOLDER + "/dwt_runtime.h5")
...
for i in range(0,40):
    ...
    spscode_x, _, _, _  = take_data(SPS_CODE_FOLDER + "/sps_code"+str(i)+".h5")
    ...
    dct_test, _, _, _  = take_data(DCT_FOLDER + "/dct_"+str(i)+".h5")
    ...
    dwt_test, _, _, _ = take_data(DWT_FOLDER + "/dwt_"+str(i)+".h5")
